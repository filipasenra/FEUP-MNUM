...
void gauss_seidel(const vector<vector<double> > & m, double x1, double x2, double x3, double x4, unsigned int num_iter) {
...
int main()
{
	...
	vector<vector<double> >  m = { { 6.00000 , 0.50000 , 3.00000 , 0.25000 , 19.00000},
